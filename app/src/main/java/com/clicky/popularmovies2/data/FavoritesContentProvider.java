...
public class FavoritesContentProvider extends ContentProvider{
    ...
    private static final String AUTHORITY = "com.clicky.popularmovies2.contentprovider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        // Set the table
        queryBuilder.setTables(FavoritesTable.TABLE_FAVS);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case TODOS:
                id = sqlDB.insert(FavoritesTable.TABLE_FAVS, null, values);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case TODOS:
                rowsDeleted = sqlDB.delete(FavoritesTable.TABLE_FAVS, selection,
                        selectionArgs);
                break;
            case TODO_ID:
                String id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(FavoritesTable.TABLE_FAVS,
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            case TODOS:
                rowsUpdated = sqlDB.update(FavoritesTable.TABLE_FAVS,
                        values,
                        selection,
                        selectionArgs);
                break;
